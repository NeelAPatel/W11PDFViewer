...
namespace W11PDFViewer.CustomControls 
{
    public sealed partial class PdfViewerCtrl : UserControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty SourceProperty =
            DependencyProperty.Register("Source", typeof(Uri), typeof(PdfViewerCtrl),
        ...
        public static readonly DependencyProperty IsZoomEnabledProperty =
            DependencyProperty.Register("IsZoomEnabled", typeof(bool), typeof(PdfViewerCtrl),
        ...
        {
            ((PdfViewerCtrl)d).OnIsZoomEnabledChanged();
        }

        private static void OnSourceChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ((PdfViewerCtrl)d).OnSourceChanged();
        }
